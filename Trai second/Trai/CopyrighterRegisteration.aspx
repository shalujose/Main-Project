<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="CopyrighterRegisteration.aspx.cs" Inherits="CopyrighterRegisteration" %>
    ...
    <table class="auto-style1">
        <tr>
            <td class="auto-style4">
                <asp:Label ID="Label13" runat="server" ForeColor="Black" Text="Copyright Registeration" Font-Bold="True"></asp:Label>
            </td>
